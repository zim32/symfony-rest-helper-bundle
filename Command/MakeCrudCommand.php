...
namespace Zim\Bundle\SymfonyRestHelperBundle\Command;
...
use Zim\Bundle\SymfonyRestHelperBundle\BaseConsoleCommand;
use Zim\Bundle\SymfonyRestHelperBundle\Command\MakeCrud\MakeCrudInfo;
...
class MakeCrudCommand extends BaseConsoleCommand
{
    ...
    public function __construct(EntityManagerInterface $em, Environment $twig, ParameterBagInterface $params)
    {
    ...
    {
        $content = $this->twig->render('@ZimSymfonyRestHelper/MakeCrud/ResourceController.php.twig', ['info' => $crudInfo]);
        $projectRoot = $this->params->get('kernel.project_dir');

        $filePath = $projectRoot . '/src/Controller/Api/V1/Resource/' . $crudInfo->getResourceSingularName() . 'Resource.php';
    ...
    {
        $projectRoot = $this->params->get('kernel.project_dir');
        $filePath    = $projectRoot . '/src/Entity/' . $crudInfo->getResourceSingularName() . '.php';
    ...
    {
        $projectRoot = $this->params->get('kernel.project_dir');
        $filePath    = $projectRoot . '/src/Form/' . $crudInfo->getPostItemOperationFormType() . '.php';
...
EOL;
    ...
    protected function generateFrontendRouterFile(MakeCrudInfo $crudInfo, string $pluginDir)
    {
        ...
        $content = $this->twig->render('@ZimSymfonyRestHelper/MakeCrud/js/routes.twig', ['info' => $crudInfo]);
    ...
    protected function generateFrontendListFile(MakeCrudInfo $crudInfo, string $pluginDir)
    {
        ...
        $content = $this->twig->render('@ZimSymfonyRestHelper/MakeCrud/js/view/List.twig', ['info' => $crudInfo]);
    ...
    protected function generateFrontendEditFormFile(MakeCrudInfo $crudInfo, string $pluginDir)
    {
        ...
        $content = $this->twig->render('@ZimSymfonyRestHelper/MakeCrud/js/view/Edit.twig', ['info' => $crudInfo]);
    ...
    protected function generateFrontendAddFormFile(MakeCrudInfo $crudInfo, string $pluginDir)
    {
        ...
        $content = $this->twig->render('@ZimSymfonyRestHelper/MakeCrud/js/view/Add.twig', ['info' => $crudInfo]);
    ...
    protected function generateFrontendBaseFormFile(MakeCrudInfo $crudInfo, string $pluginDir)
    {
        ...
        $content = $this->twig->render('@ZimSymfonyRestHelper/MakeCrud/js/view/Form.twig', ['info' => $crudInfo]);
